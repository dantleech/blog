...
But I got there in the end (and published the [package](https://github.com/php-tui/cassowarhttps://github.com/php-tui/cassowaryy)) **without really understanding how it works** (you can
[read the
...
`Tview` used Golang's standard `image` module. PHP has two main graphics
