...
Crtossterm. Give it a [star](https://github.com/php-tui/term).
...
commands into a buffer, which is either flushed implictily when it's full or
...
returning the cursor to the start of the line when ther is a newline, or
