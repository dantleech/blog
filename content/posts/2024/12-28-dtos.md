...
people's opinions. **Take What you Can Find, Find What You Can Take and Find what Works for YOU and YOUR projects**.
...
[^serialize]: the serializer would be default encode the "distance" as an
    JSON object for example, but we'd Sportster would expect it to be an
