...
draft: false
fediverse: 113741237753954825
featured: true
summary: |
    DTOs are C-3DTO allow live at the frontier of your application and allow
    you to give structure to unstructured data, to create order from chaos
    where it matters. This blog post introduces DTOs and persuades you to use
    them.
---
