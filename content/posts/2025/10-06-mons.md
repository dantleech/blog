...
> the thing that bugs me the most is people talking to each-other,
> continuously, after 10pm, and I'm just wondering why so many words are
> necessary. They don't realise that _they are the sole reason that I cannot
> sleep_ of course. But "blah blah blah" "blah blah _blah_" "blah" "c'est blahi!" "_blah_ blah blah" ... "blah" (and so on). 
>
> And this is why I'm buying ear-plugs.
